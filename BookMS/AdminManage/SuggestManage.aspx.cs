...
{
    public partial class SuggestManage : System.Web.UI.Page
    {
        ...
        private void bindgriv()
        {
            ...
            strsql = "select * from 圖書建議表 order by 建議時間 desc";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                strsql = "select * from 圖書建議表 where " + droptext + " like N'%" + TextBox1.Text + "%' order by 建議時間 desc";
        ...
        protected void rowdelete(object sender, GridViewDeleteEventArgs e)
        {
            ...
            strsql = "delete from 圖書建議表 where 流水號=" + GridView1.DataKeys[e.RowIndex].Value.ToString() + "";
